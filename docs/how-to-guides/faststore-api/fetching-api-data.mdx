...
If you need data that is not available on the native [FastStore GraphQL schema](https://www.faststore.dev/reference/api/objects), check the [root object](/how-to-guides-faststore-api/using-the-faststore-api-root-object-fields).
