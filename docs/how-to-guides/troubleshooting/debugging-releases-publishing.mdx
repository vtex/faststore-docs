...
2. Check if your Release status corresponds to **Publishing**. If yes, open the Release and copy the hexadecimal identifier (e.g., `635feddd372d5fef67c4160e`) presented at the end of the page URL (e.g., `/admin/releases/635feddd372d5fef67c4160e`). If not, [open a support ticket describing your issue.](https://help.vtex.com/support)
...
2. Check the status of the **Build check** for that commit by clicking on one of the following marks:
   ...
   - <span className="text-lg text-yellow-500">●</span> <strong>Circle mark</strong> - the build is queued and waiting for other builds to complete. If queued for longer than 45 minutes, please <a hred="https://help.vtex.com/support">open a support ticket.</a>
...
If faced with the **Deploying development preview** and **Development deploy preview failed** errors, a technical issue on our end prevented WebOps from deploying your code. [Open a support ticket](https://help.vtex.com/support) describing the issue.
